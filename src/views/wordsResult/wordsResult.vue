            ...
            <Card :bordered="false" dis-hover class="card">
              <div slot="title" class="wordsDiv">
                 ...
                 <span class="words-voice">
                  <span>英:[<span v-text="wordsEntry.voice.ph_en"></span>]&nbsp;
                    ...
                    <Icon type="volume-medium"></Icon></a>
                  </span>
                  <!--  -->
                  <span>美:[<span v-text="wordsEntry.voice.ph_am"></span>]&nbsp;
            ...
            <Col span="16" style="margin-top:20px;">
                  ...
                  <ol class="exampleList">
                    <li v-for="wExample in wordsExamples">
                      <p class="annotation">{{wExample.first}}<span class="example-mid">{{wExample.mid}}</span>{{wExample.last}}</p><br>
